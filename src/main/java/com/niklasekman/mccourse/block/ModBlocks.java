package com.niklasekman.mccourse.block;
...
public class ModBlocks {
    ...
    public static final Block END_STONE_RUBY_ORE = registerBlock("end_stone_ruby_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.END_STONE).strength(2f), UniformIntProvider.create(4,7)));
